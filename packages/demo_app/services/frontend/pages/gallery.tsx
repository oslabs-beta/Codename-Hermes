...
import apirateslifeforme from '../assets/apirateslifeforme.png';
import dotsoncardstock from '../assets/dotsoncardstock.png';
import heart from '../assets/heart.png';
import seaturtle from '../assets/seaturtle.png';
import starrynightmixedmedia from '../assets/starrynightmixedmedia.png';
import undertherainbow from '../assets/undertherainbow.png';
import underwaterseascape from '../assets/underwaterseascape.png';
  ...
  return (
    <div className='flex flex-col'>
      ...
      <p>
        ...
        in this exhibit is a unique expression of the artist's vision. We invite
        you to take a closer look and discover the beauty and diversity of these
        wonderful works of art.
      </p>
      <div className='galDisp'>
        {artWork.map((img, index) => (
          <img src={img} key={index} className='galImg'></img>
        ))}
      </div>
    </div>
  );
